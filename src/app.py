...
activities = {
    ...
    "Soccer Club": {
        "description": "Improve soccer technique and enjoy friendly matches",
    ...
    "Drama Club": {
        "description": "Rehearse scenes, improve acting skills, and produce school plays",
    ...
    "Debate Team": {
        "description": "Build public speaking and critical thinking skills for debate tournaments",
